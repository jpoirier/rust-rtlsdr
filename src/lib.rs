...
pub const DefaultFc: i32 = 80_000_000;
pub const DefaultRs: i32 = 1_024_000;
pub const DefaultReadSize: i32 = 1024;
pub const CrystalFreq: i32 = 28800000;
pub const DefaultSampleRate: i32 = 2048000;
pub const DefaultAsyncBufNumber: i32 = 32;
pub const DefaultBufLength: i32 = (16 * 16384);
pub const MinBufLength: i32 = 512;
pub const MaxBufLength: i32 = (256 * 16384);
...
fn from_tuner_type(t: rtlsdr_tuner) -> String {
    match t {
        rtlsdr_tuner::RTLSDR_TUNER_UNKNOWN => String::from("Unknown"),
        rtlsdr_tuner::RTLSDR_TUNER_E4000 => String::from("E4000"),
        rtlsdr_tuner::RTLSDR_TUNER_FC0012 => String::from("FC0012"),
        rtlsdr_tuner::RTLSDR_TUNER_FC0013 => String::from("FC0013"),
        rtlsdr_tuner::RTLSDR_TUNER_FC2580 => String::from("FC2580"),
        rtlsdr_tuner::RTLSDR_TUNER_R820T => String::from("R820T"),
        rtlsdr_tuner::RTLSDR_TUNER_R828D => String::from("R828D"),
    }
}
...
impl Device {
    ...
    pub fn read_eeprom(&self, offset: u8, len: u16) -> (Vec<u8>, Error) {
        ...
        unsafe {
            let err = rtlsdr_read_eeprom(self.dev, v.as_mut_ptr() as *mut uint8_t, offset, len);
            (v, get_err_msg(err))
        }
